function [err,P,pChoiceT] = wrapper_dtb_parametricbound_rt_extATT_VarDrift(theta,...
...
if numel(choice)>1
    ...
    %% print
    fprintf('err=%.3f kappa=%.2f B0=%.2f a=%.2f d=%.2f coh0=%.2f y0=%.2f omega=%.2f std_drift=%.2f\n',...
        err,kappa,B0,a,d,coh0,y0a,omega, std_drift);
