...
% Plots the ATT-VarDrift-2D model predictions against behavioral data.
%
% USAGE:
...
switch flag
    case 2
        ...
        extra   = '_flat_bounds';
        fig_str = 'ATT model (intra-decisional attention, inter-trial value variability, flat bounds)';
end
...
figname = ['fig_ATT_VarDrift_2D', extra];
