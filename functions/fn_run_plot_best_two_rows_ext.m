function p = fn_run_plot_best_two_rows_ext(d,m, flags)
...
p = publish_plot(2,5);
p.shrink(1:8,0.9,1);
set(gcf,'Position',[194   452  1289   435]);
...
set(p.h_ax(5),'xtick',[-1:0.25:0],'xticklabel',[-1:0.25:0]);
...
h = p.letter_the_plots('show',[1:4,6:8]);
set(h,'FontSize',11);
