#include "mex.h"
/* single_timebarrier_cross_rectified2(ev,Bound,lower_bound)
 ...
 * CONTINUES TO BE INTEGRATED. Only a single positive bound is permitted. The second output is the
 * sample (linear interpolation) at which the bound was reached; it's set to NaN
 * after the barrier is reached.
